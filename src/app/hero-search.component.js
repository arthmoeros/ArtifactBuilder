...
var HeroSearchComponent = (function () {
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        this.heroes = this.searchTerms
            .debounceTime(300) //delay en ms despues de cada tecla pulsada antes de comenzar la busqueda
            .distinctUntilChanged() // ignorar la nueva busqueda si es la misma palabra
